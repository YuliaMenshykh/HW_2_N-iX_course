...
#define UE_PROJECT_NAME RadioProject
#define UE_TARGET_NAME RadioProjectEditor
#define UE_MODULE_NAME "RadioProject"
...
#define RADIOPROJECT_API DLLEXPORT
